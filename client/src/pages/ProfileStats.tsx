                ...
                {userStats?.social ? (
                  <section>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <StatTile
                        label="Prost erhalten"
                        value={String(userStats.social.prostReceived)}
                      />
                      <div className="rounded-2xl border border-border bg-card p-3">
              ...
              <>
                <section>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <StatTile
                      label="Gutscheine gesendet"
                      value={String(systemStats?.allTimeProstSent)}
                    />
                  </div>
                </section>
                ...
                <section>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <StatTile
                      label="Gesamtumsatz"
                      value={formatCents(systemStats?.totalRevenue ?? 0)}
                    />
                    <StatTile
                ...
                <section>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <StatTile
                      label="Gesamte Spins"
                      value={String(systemStats?.allTimeJackpotSpins)}
                    />
                    <StatTile
